...
@implementation CLGoogleDeleteFeedOperation
...
- (void)main {
	...
	@try {
		...
		CLLog(@"deleting feed %@...", feedGoogleUrl);
		...
		[self deleteSubscriptionForUrlString:feedGoogleUrl token:token auth:googleAuth statusCode:&statusCode];
