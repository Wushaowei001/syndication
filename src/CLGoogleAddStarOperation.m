...
@implementation CLGoogleAddStarOperation
...
- (void)main {
	...
	@try {
		...
		[self addTag:@"user/-/state/com.google/starred" forUrlString:feedGoogleUrl item:itemGuid token:token auth:googleAuth statusCode:&statusCode];
