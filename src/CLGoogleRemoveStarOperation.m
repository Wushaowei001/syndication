...
@implementation CLGoogleRemoveStarOperation
...
- (void)main {
	...
	@try {
		...
		[self removeTag:@"user/-/state/com.google/starred" forUrlString:feedGoogleUrl item:itemGuid token:token auth:googleAuth statusCode:&statusCode];
